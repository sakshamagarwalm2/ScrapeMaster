...
import { FileTypeIcon, MoreVerticalIcon, PlayIcon, ShuffleIcon, TrashIcon } from 'lucide-react'
...
function WorkflowCard({workflow}:{workflow: Workflow}) {
    ...
    return( <Card className='border border-separate shadow-sm rounded-lg overflow-hidden hover:shadow-md' >
        <CardContent className='p-4 flex item-center justify-between h-[100px'>
            ...
            <div>
                <h3 className="text-base font-bold text-muted-foreground flex item-center">
